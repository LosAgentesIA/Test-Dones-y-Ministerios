...
<header>
  <span class="marca">Instituto Ministerial del EspÃ­ritu Santo</span>
...
<main>
  ...
  <section id="vista-datos" class="vista">
    ...
    <div class="campo">
      ...
      <p id="error-email" class="error oculto">Por favor ingresa un email vÃ¡lido.</p>
    </div>
    <h3>Elige un test</h3>
  ...
  <section id="vista-resultados" class="vista">
    <div class="resultado-imprimible">
      <div class="pdf-membrete">Instituto Ministerial del EspÃ­ritu Santo</div>
      <h2>Resultados</h2>
...
(function () {
  ...
  function mostrarResultados() {
    ...
    const perfilMap = {
      "9 Dones del EspÃ­ritu Santo": "este es tu perfil de los 9 Dones del EspÃ­ritu Santo",
